...
{
    public class ApprenticeshipLocationsTests : MvcTestBase
    {
        ...
        [Theory]
        [InlineData(ApprenticeshipLocationType.ClassroomBased, "/new-apprenticeship-provider/add-apprenticeship-classroom-location")]
