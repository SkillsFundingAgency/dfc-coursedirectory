...
namespace Dfc.CourseDirectory.Core.Validation
{
    public static class ErrorRegistry
    {
        public static IReadOnlyDictionary<string, Error> All { get; } = new[]
        {
            ...
            new Error("COURSE_WHAT_YOU_CAN_DO_NEXT_NO_HTML"),
            new Error("COURSE_HOW_YOU_WILL_BE_ASSESSED_NO_HTML"),
            new Error("COURSE_ENTRY_REQUIREMENTS_NO_HTML"),
            new Error("COURSE_WHAT_YOU_WILL_LEARN_NO_HTML"),
            new Error("COURSE_HOW_YOU_WILL_LEARN_NO_HTML"),
            new Error("COURSE_WHAT_YOU_WILL_NEED_TO_BRING_NO_HTML"),
            ...
            new Error("COURSERUN_COURSE_WEB_PAGE_REQUIRED"),
            ...
            new Error("COURSE_SECTOR_REQUIRED"),
