...
{
    public class GetCourseUpdateItemHandler : ISqlQueryHandler<GetCourseUpdates, ListOfCourseUpdates>
    {
        public async Task<ListOfCourseUpdates> Execute(SqlTransaction transaction, GetCourseUpdates query)
        {
            var sql = $@"SELECT 
                        ...
                        SELECT
                            ...
                            cr.CreatedOn,
                            cr.UpdatedOn,
                            c.UpdatedOn as courseUpdatedOn,
                            v.UpdatedOn as venueUpdatedOn,
                            cr.CourseId,
                            cr.CourseName,
                            c.CourseType,
            ...
            var courses = (await queryReader.ReadAsync<CourseUpdateItem>()).ToList();

            var listOfCourses = new ListOfCourseUpdates()
            {
