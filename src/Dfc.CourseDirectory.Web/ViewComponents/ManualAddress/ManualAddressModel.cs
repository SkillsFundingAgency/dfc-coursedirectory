...
namespace Dfc.CourseDirectory.Web.ViewComponents.ManualAddress
{
    public class ManualAddressModel
    {
        ...
        [RegularExpression(@"[a-zA-Z\.\-']+(?: [a-zA-Z0-9\.\-']+)*$", ErrorMessage = "Address line 1 must only include letters a to z, numbers, hyphens and spaces")]
        ...
        [RegularExpression(@"[a-zA-Z\.\-']+(?: [a-zA-Z0-9\.\-']+)*$", ErrorMessage = "Address line 2 must only include letters a to z, numbers, hyphens and spaces")]
