...
namespace Dfc.CourseDirectory.Web.Controllers.ProviderSearch
{
    ...
    public class ProviderSearchController : Controller
    {
            ...
            string Keyword)
        {
            ...
            ProviderAzureSearchResultModel result = (await _courseService.ProviderSearchAsync(criteria)).Value;
