function ArchiveCoursesForProvider(ukprn) {
    ...
    function tryQueryAndUpdate(continuation) {
        var query = {
            query: "select * from courses c where c.CourseStatus <> @archivedStatus and c.ProviderUKPRN = @ukprn",
            parameters: [
    ...
    function tryUpdate(document) {
        ...
        document.CourseStatus = archivedStatus;
        document.CourseRuns.forEach(l => l.RecordStatus = archivedStatus);
