...
namespace Dfc.CourseDirectory.Core.DataManagement
{
    public sealed class SaveProviderFileResult
    {
        ...
        public static SaveProviderFileResult InvalidRows() =>
            new SaveProviderFileResult()
            {
                MissingHeaders = Array.Empty<string>(),
                Status = SaveProviderFileResultStatus.InvalidRows
            };

        public static SaveProviderFileResult Success(Guid venueUploadId, UploadStatus uploadStatus) =>
            new SaveProviderFileResult()
            {
                MissingHeaders = Array.Empty<string>(),
