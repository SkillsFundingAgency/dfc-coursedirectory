...
(ProviderId, SubmittedOn, SubmittedByUserId, ProviderBriefOverview, ApprenticeshipQAStatus)
VALUES (@ProviderId, @SubmittedOn, @SubmittedByUserId, @ProviderBriefOverview, 1)
