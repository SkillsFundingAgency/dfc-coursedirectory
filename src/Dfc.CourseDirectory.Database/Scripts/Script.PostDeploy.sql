...
;WITH TLevelDefinitionsCte AS (
	...
	(
		...
		N'Your learning will combine classroom theory and practical learning and include 9 weeks (minimum) of industry placement. The placement will provide you with real experience of the workplace.',
		N'You will be assessed by completing an employer set project and a project on your specialist subject. You''ll have time to research and complete tasks. There''ll also be 2 exams.' + CHAR(13) + CHAR(13) + 'You''ll work with your tutor to decide when you''re ready to be assessed.',
		N'This course is suitable for anyone wanting a career in IT, specifically in areas such as IT solutions or data analysis.' + CHAR(13) + CHAR(13) + 'Speak to your careers adviser to find out more.' + CHAR(13) + CHAR(13) + 'Students can also use this T Level to progress to a related higher-level apprenticeship or course of study at a higher level.'
	),
	(
		...
		N'This T Level is suitable for anyone wanting a career in digital infrastructure and support.' + CHAR(13) + CHAR(13) + 'The T Level is a 2 year programme and will include a 9 week (minimum) industry placement and a Technical Qualification, where you will also choose a specialist subject.',
		N'There are no national entry requirements for starting a T Level. These are set by the individual college or school. Contact us to find out more.',
		N'You will develop a general understanding of digital services, including:' + CHAR(13) + CHAR(13) + 'How digital technologies impact business and market environment' + CHAR(13) + 'The ethical and moral implications of digital technology' + CHAR(13) + 'Using data in software design' + CHAR(13) + 'Using digital technologies to analyse and solve problems' + CHAR(13) + 'Digital environments, including physical, virtual and cloud environments' + CHAR(13) + 'Legal and regulatory obligations relating to digital technologies' + CHAR(13) + 'The privacy and confidentiality of personal data' + CHAR(13) + 'The technical, physical and human aspects of internet security' + CHAR(13) + 'Planning digital projects' + CHAR(13) + 'Testing software, hardware and data' + CHAR(13) + 'Digital tools for project management and collaboration' + CHAR(13) + CHAR(13) + 'In addition to the core content, you will choose one of the following as a specialist subject:' + CHAR(13) + CHAR(13) + 'Digital infrastructure' + CHAR(13) + 'Network cabling' + CHAR(13) + 'Unified communications' + CHAR(13) + 'Digital support',
		N'Your learning will combine classroom theory and practical learning and include 9 weeks (minimum) of industry placement. The placement will provide you with real experience of the workplace.',
		N'You will be assessed by completing an employer set project and a project on your specialist subject. You''ll have time to research and complete tasks. There''ll also be 2 exams.' + CHAR(13) + CHAR(13) + 'You''ll work with your tutor to decide when you''re ready to be assessed.',
		N'This course is suitable for anyone wanting a career in digital infrastructure and support.' + CHAR(13) + CHAR(13) + 'Career options might include becoming an infrastructure technician or a role in IT support.' + CHAR(13) + CHAR(13) + 'Speak to your careers adviser to find out more.' + CHAR(13) + CHAR(13) + 'Students can also use this T Level to progress to a related higher-level apprenticeship or course of study at a higher level.'
	),
	(
		...
		N'This T Level is suitable for anyone wanting a career in health and healthcare.' + CHAR(13) + CHAR(13) + 'The T Level is a 2 year programme and will include a 9 week (minimum) industry placement and a Technical Qualification, where you will also choose a specialist subject.',
		N'There are no national entry requirements for starting a T Level. These are set by the individual college or school. Contact us to find out more.',
		N'You will develop a general understanding of health and science, including:' + CHAR(13) + CHAR(13) + 'Working within the health and science sector' + CHAR(13) + 'Health, safety and environmental regulations' + CHAR(13) + 'Managing information and data' + CHAR(13) + 'Principles of good scientific and clinical practice' + CHAR(13) + 'Core science concepts including the structure of cells, tissues and large molecules, genetics, microbiology and immunology' + CHAR(13) + CHAR(13) + 'You will also develop the knowledge and skills specific to health, such as:' + CHAR(13) + CHAR(13) + 'Understanding the healthcare sector' + CHAR(13) + 'Providing person-centred care' + CHAR(13) + 'Supporting health and wellbeing' + CHAR(13) + 'Further knowledge of both human anatomy and physiology and of diseases and disorders' + CHAR(13) + 'Infection prevention and control' + CHAR(13) + CHAR(13) + 'In addition to the core content, you will choose one of the following as a specialist subject:' + CHAR(13) + CHAR(13) + 'Supporting the adult nursing team' + CHAR(13) + 'Supporting the midwifery team' + CHAR(13) + 'Supporting the mental health team' + CHAR(13) + 'Supporting the care of children and young people' + CHAR(13) + 'Supporting the therapy teams ' + CHAR(13) + 'Dental nursing (from September 2022)',
		N'Your learning will combine classroom theory and practical learning and include 9 weeks (minimum) of industry placement. The placement will provide you with real experience of the workplace.',
		N'You will be assessed by completing an employer set project and a project on your specialist subject. You''ll have time to research and complete tasks. There''ll also be 2 exams.' + CHAR(13) + CHAR(13) + 'You''ll work with your tutor to decide when you''re ready to be assessed.',
		N'You''ll have the industry knowledge and experience to progress into roles like:' + CHAR(13) + CHAR(13) + 'Midwifery' + CHAR(13) + 'Ambulance support' + CHAR(13) + CHAR(13) + 'or to go onto an apprenticeship or higher education.'
	),
	(
		...
		N'This T Level is suitable for anyone wanting a career in health or science.' + CHAR(13) + CHAR(13) + 'The T Level is a 2 year programme and will include a 9 week (minimum) industry placement and a Technical Qualification, where you will also choose a specialist subject.',
		N'There are no national entry requirements for starting a T Level. These are set by the individual college or school. Contact us to find out more.',
		N'You will develop a general understanding of health and science, including:' + CHAR(13) + CHAR(13) + 'working within the health and science sector' + CHAR(13) + 'health, safety and environmental regulations' + CHAR(13) + 'managing information and data' + CHAR(13) + 'principles of good scientific and clinical practice' + CHAR(13) + 'core science concepts including the structure of cells, tissues and large molecules, genetics, microbiology and immunology' + CHAR(13) + CHAR(13) + 'You will also develop the knowledge and skills specific to healthcare science:' + CHAR(13) + CHAR(13) + 'Understanding the healthcare science sector' + CHAR(13) + 'Further knowledge of human anatomy and physiology, diseases and disorders, genomics and medical physics' + CHAR(13) + 'Providing person-centred care' + CHAR(13) + 'Infection prevention and control' + CHAR(13) + 'Good scientific practice' + CHAR(13) + CHAR(13) + 'In addition to the core content, you will choose one of the following as a specialist subject:' + CHAR(13) + CHAR(13) + 'Assisting with healthcare science' + CHAR(13) + 'Optical care services (from September 2022)',
		N'Your learning will combine classroom theory and practical learning and include 9 weeks (minimum) of industry placement. The placement will provide you with real experience of the workplace.',
		N'You will be assessed by completing an employer set project and a project on your specialist subject. You''ll have time to research and complete tasks. There''ll also be 2 exams.' + CHAR(13) + CHAR(13) + 'You''ll work with your tutor to decide when you''re ready to be assessed.',
		N'You''ll have the industry knowledge and experience to progress into roles like:' + CHAR(13) + CHAR(13) + 'Clinical analyst' + CHAR(13) + 'Healthcare science associate' + CHAR(13) + CHAR(13) + 'or to go onto an apprenticeship or higher education.'
	),
	(
		...
		N'This T Level is suitable for anyone wanting a career in science.' + CHAR(13) + CHAR(13) + 'The T Level is a 2 year programme and will include a 9 week (minimum) industry placement and a Technical Qualification, where you will also choose a specialist subject.',
		N'There are no national entry requirements for starting a T Level. These are set by the individual college or school. Contact us to find out more.',
		N'You will develop a general understanding of health and science, including:' + CHAR(13) + CHAR(13) + 'Working within the health and science sector' + CHAR(13) + 'Health, safety and environmental regulations' + CHAR(13) + 'Managing information and data' + CHAR(13) + 'Principles of good scientific and clinical practice' + CHAR(13) + 'Core science concepts including the structure of cells, tissues and large molecules, genetics, microbiology and immunology' + CHAR(13) + CHAR(13) + 'You will also develop the knowledge and skills specific to science:' + CHAR(13) + CHAR(13) + 'Understanding the science sector' + CHAR(13) + 'Further science knowledge, including cell cycle and cellular respiration, enzyme and protein structure, pathogens, classification of biological materials, kinetic Changes and relevant analytical techniques' + CHAR(13) + 'Scientific methodology' + CHAR(13) + 'Experimental equipment and techniques' + CHAR(13) + 'Ethics of science' + CHAR(13) + CHAR(13) + 'In addition to the core content, you will choose one of the following as a specialist subject:' + CHAR(13) + CHAR(13) + 'Laboratory sciences' + CHAR(13) + 'Food sciences' + CHAR(13) + 'Metrology sciences',
		N'Your learning will combine classroom theory and practical learning and include 9 weeks (minimum) of industry placement. The placement will provide you with real experience of the workplace.',
		N'You will be assessed by completing an employer set project and a project on your specialist subject. You''ll have time to research and complete tasks. There''ll also be 2 exams.' + CHAR(13) + CHAR(13) + 'You''ll work with your tutor to decide when you''re ready to be assessed.',
		N'You''ll have the industry knowledge and experience to progress into roles like:' + CHAR(13) + CHAR(13) + 'Technical support scientist' + CHAR(13) + 'Metrology technician ' + CHAR(13) + 'Food technician' + CHAR(13) + CHAR(13) + 'or to go onto an apprenticeship or higher education.'
	),
	(
		...
		N'This T Level is suitable for anyone wanting a career in construction, specifically in bricklaying, carpentry and joinery, plastering or painting and decorating.' + CHAR(13) + CHAR(13) + 'The T Level is a 2 year programme and will include a 9 week (minimum) industry placement and a Technical Qualification, where you will also choose a specialist subject.',
		N'There are no national entry requirements for starting a T Level. These are set by the individual college or school. Contact us to find out more.',
		N'You will develop a general understanding of construction, including;' + CHAR(13) + CHAR(13) + 'Health and safety' + CHAR(13) + 'The science behind building design, surveying and planning' + CHAR(13) + 'Making accurate and appropriate measurements' + CHAR(13) + 'Construction methods' + CHAR(13) + 'Building regulations and standards' + CHAR(13) + 'Data management and information standards in construction' + CHAR(13) + 'Relationship management and customer service' + CHAR(13) + 'How the Internet of Things (IoT) impacts construction' + CHAR(13) + 'Digital engineering techniques' + CHAR(13) + 'Mathematical techniques to solve construction problems' + CHAR(13) + 'Construction design principles and processes' + CHAR(13) + 'The construction industry and its role in the economy' + CHAR(13) + 'Sustainability and the environmental impact of construction' + CHAR(13) + 'Business, commerce and corporate social responsibility' + CHAR(13) + CHAR(13) + 'In addition to the core content, you will choose one of the following as a specialist subject:' + CHAR(13) + CHAR(13) + 'Bricklaying' + CHAR(13) + 'Carpentry and joinery' + CHAR(13) + 'Plastering' + CHAR(13) + 'Painting and decorating',
		N'Your learning will combine classroom theory and practical learning and include 9 weeks (minimum) of industry placement. The placement will provide you with real experience of the workplace.',
		N'You will be assessed by completing an employer set project and a project on your specialist subject. You''ll have time to research and complete tasks. There''ll also be 2 exams.' + CHAR(13) + CHAR(13) + 'You''ll work with your tutor to decide when you''re ready to be assessed.',
		N'You''ll have the industry knowledge and experience to progress into roles like:' + CHAR(13) + CHAR(13) + 'Advanced site carpenter' + CHAR(13) + 'Joiner' + CHAR(13) + 'Construction assembly and installation operative' + CHAR(13) + CHAR(13) + 'or to go onto an apprenticeship or higher education.'
	),
	(
		...
		N'This T Level is suitable for anyone wanting a career in construction, specifically in areas such as electric installation and maintenance, plumbing or heating.' + CHAR(13) + CHAR(13) + 'The T Level is a 2 year programme and will include a 9 week (minimum) industry placement and a Technical Qualification, where you will also choose a specialist subject.',
		N'There are no national entry requirements for starting a T Level. These are set by the individual college or school. Contact us to find out more.',
		N'You will develop a general understanding of construction, including:' + CHAR(13) + CHAR(13) + 'Health and safety' + CHAR(13) + 'The science behind building design, surveying and planning' + CHAR(13) + 'Making accurate and appropriate measurements' + CHAR(13) + 'Construction methods' + CHAR(13) + 'Building regulations and standards' + CHAR(13) + 'Data management and information standards in construction' + CHAR(13) + 'Relationship management and customer service' + CHAR(13) + 'How the Internet of Things (IoT) impacts construction' + CHAR(13) + 'Digital engineering techniques' + CHAR(13) + 'Mathematical techniques to solve construction problems' + CHAR(13) + 'Construction design principles and processes' + CHAR(13) + 'The construction industry and its role in the economy' + CHAR(13) + 'Sustainability and the environmental impact of construction' + CHAR(13) + 'Business, commerce and corporate social responsibility' + CHAR(13) + CHAR(13) + 'In addition to the core content, you will choose one of the following as a specialist subject:' + CHAR(13) + CHAR(13) + 'Electrical and electronic equipment engineering' + CHAR(13) + 'Electrotechnical engineering' + CHAR(13) + 'Gas engineering' + CHAR(13) + 'Protection systems engineering' + CHAR(13) + 'Plumbing and heating engineering' + CHAR(13) + 'Heating engineering and ventilation' + CHAR(13) + 'Refrigeration engineering and air conditioning engineering',
		N'Your learning will combine classroom theory and practical learning and include 9 weeks (minimum) of industry placement. The placement will provide you with real experience of the workplace.',
		N'You will be assessed by completing an employer set project and a project on your specialist subject. You''ll have time to research and complete tasks. There''ll also be 2 exams.' + CHAR(13) + CHAR(13) + 'You''ll work with your tutor to decide when you''re ready to be assessed.',
		N'This course is suitable for anyone wanting a career in construction, specifically in areas such as electric installation and maintenance, plumbing or heating.' + CHAR(13) + CHAR(13) + 'Speak to your careers adviser to find out more.' + CHAR(13) + CHAR(13) + 'Students can also use this T Level to progress to a related higher-level apprenticeship or course of study at a higher level.'
	)
