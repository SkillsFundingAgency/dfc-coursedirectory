...
using Dfc.CourseDirectory.WebV2.ViewModels.DataManagement.Courses;
using FormFlow;
using MediatR;
...
namespace Dfc.CourseDirectory.WebV2.Controllers
{
    ...
    public class CoursesDataManagementController : Controller
    {
        ...
        public async Task<IActionResult> Index() =>
            await _mediator.SendAndMapResponse(new ViewModels.DataManagement.Courses.Upload.Query(), vm => View("Upload", vm));

        [HttpGet("nonlars")]
        public async Task<IActionResult> NonLars() =>
            await _mediator.SendAndMapResponse(new ViewModels.DataManagement.Courses.Upload.Query(), vm => View("UploadNonLars", vm));

        [HttpPost("upload")]
        public async Task<IActionResult> Upload(ViewModels.DataManagement.Courses.Upload.Command command)
        {
            var file = Request.Form.Files?.GetFile(nameof(command.File));

            return await _mediator.SendAndMapResponse(
                new ViewModels.DataManagement.Courses.Upload.Command()
                {
                    File = file,
                    IsNonLars = false
                },
        ...
        public async Task<IActionResult> UploadNonLars(ViewModels.DataManagement.Courses.Upload.Command command)
        {
            var file = Request.Form.Files?.GetFile(nameof(command.File));
        ...
        public async Task<IActionResult> ResolveList() =>
            await _mediator.SendAndMapResponse(
                new ViewModels.DataManagement.Courses.ResolveList.Query() { IsNonLars = false },
        ...
        public async Task<IActionResult> NonLarsResolveList() =>
            await _mediator.SendAndMapResponse(
                new ViewModels.DataManagement.Courses.ResolveList.Query() { IsNonLars = true },
                result => result.Match<IActionResult>(
        ...
        public async Task<IActionResult> ResolveRowDeliveryMode(ViewModels.DataManagement.Courses.ResolveRowDeliveryMode.Query query)
        {
        ...
        public async Task<IActionResult> ResolveNonLarsRowDeliveryMode(ViewModels.DataManagement.Courses.ResolveRowDeliveryMode.Query query)
        {
        ...
        public async Task<IActionResult> ResolveRowDeliveryMode([FromRoute] int rowNumber, ViewModels.DataManagement.Courses.ResolveRowDeliveryMode.Command command)
        {
        ...
        public async Task<IActionResult> ResolveNonLarsRowDeliveryMode([FromRoute] int rowNumber, ViewModels.DataManagement.Courses.ResolveRowDeliveryMode.Command command)
        {
        ...
        public async Task<IActionResult> ResolveRowDescription(ViewModels.DataManagement.Courses.ResolveRowDescription.Query query)
        {
            query.IsNonLars = false;
        ...
        public async Task<IActionResult> ResolveNonLarsRowDescription(ViewModels.DataManagement.Courses.ResolveRowDescription.Query query)
        {
            //Generate Live service URL accordingly based on current host
            query.IsNonLars = true;
            string host = HttpContext.Request.Host.ToString();
        ...
        public async Task<IActionResult> ResolveRowDescription([FromRoute] int rowNumber, ViewModels.DataManagement.Courses.ResolveRowDescription.Command command)
        {
            command.RowNumber = rowNumber;
            command.IsNonLars = false;
        ...
        public async Task<IActionResult> ResolveNonLarsRowDescription([FromRoute] int rowNumber, ViewModels.DataManagement.Courses.ResolveRowDescription.Command command)
        {
            command.RowNumber = rowNumber;
            command.IsNonLars = true;
        ...
        {
            var query = new ViewModels.DataManagement.Courses.ResolveRowDetails.Query()
            {
        ...
        public async Task<IActionResult> ResolveRowDetails(
            [FromRoute] int rowNumber,
            [ModelBinder(typeof(DeliveryModeModelBinder))] CourseDeliveryMode deliveryMode,
            ViewModels.DataManagement.Courses.ResolveRowDetails.Command command)
        {
            command.RowNumber = rowNumber;
        ...
        public async Task<IActionResult> InProgress() => await _mediator.SendAndMapResponse(
            new ViewModels.DataManagement.Courses.InProgress.Query() { IsNonLars = false },
            result => result.Match(
                notFound => NotFound(),
        ...
        public async Task<IActionResult> NonLarsInProgress() => await _mediator.SendAndMapResponse(
            new ViewModels.DataManagement.Courses.InProgress.Query() { IsNonLars = true },
            result => result.Match(
                notFound => NotFound(),
                status => status switch
                {
        ...
        public async Task<IActionResult> DeleteUpload() =>
            await _mediator.SendAndMapResponse(
                new ViewModels.DataManagement.Courses.DeleteUpload.Query() { IsNonLars = false },
                command => View(command));

        [HttpGet("nonlars-delete")]
        public async Task<IActionResult> NonLarsDeleteUpload() =>
           await _mediator.SendAndMapResponse(
               new ViewModels.DataManagement.Courses.DeleteUpload.Query() { IsNonLars = true },
               command => View(command));

        [HttpPost("delete")]
        public async Task<IActionResult> DeleteUpload(ViewModels.DataManagement.Courses.DeleteUpload.Command command)
        {
            command.IsNonLars = false;
            return await _mediator.SendAndMapResponse(
                command,
        ...
        public async Task<IActionResult> NonLarsDeleteUpload(ViewModels.DataManagement.Courses.DeleteUpload.Command command)
        {
            command.IsNonLars = true;
            return await _mediator.SendAndMapResponse(
                command,
        ...
        public async Task<IActionResult> Download() => await _mediator.SendAndMapResponse(
            new ViewModels.DataManagement.Courses.Download.Query() { IsNonLars = false },
        ...
        public async Task<IActionResult> DownloadNonLars() => await _mediator.SendAndMapResponse(
           new ViewModels.DataManagement.Courses.Download.Query() { IsNonLars = true },
        ...
        public async Task<IActionResult> DeleteRowGroup([FromRoute] int rowNumber) =>
            await _mediator.SendAndMapResponse(new ViewModels.DataManagement.Courses.DeleteRowGroup.Query() { RowNumber = rowNumber, IsNonLars = false }, vm => View(vm));

        [HttpPost("resolve/{rowNumber}/course/delete/")]
        public async Task<IActionResult> DeleteRowGroup([FromRoute] int rowNumber, ViewModels.DataManagement.Courses.DeleteRowGroup.Command command)
        {
            command.IsNonLars = false;
            command.RowNumber = rowNumber;
            return await _mediator.SendAndMapResponse(
        ...
        public async Task<IActionResult> DeleteNonLarsRowGroup([FromRoute] int rowNumber) =>
            await _mediator.SendAndMapResponse(new ViewModels.DataManagement.Courses.DeleteRowGroup.Query() { RowNumber = rowNumber, IsNonLars = true }, vm => View(vm));

        [HttpPost("nonlars-resolve/{rowNumber}/course/delete/")]
        public async Task<IActionResult> DeleteNonLarsRowGroup([FromRoute] int rowNumber, ViewModels.DataManagement.Courses.DeleteRowGroup.Command command)
        {
            command.IsNonLars = true;
            command.RowNumber = rowNumber;
            return await _mediator.SendAndMapResponse(
        ...
        {
            var query = new ViewModels.DataManagement.Courses.CheckAndPublish.Query() { IsNonLars = false };
        ...
        {
            var query = new ViewModels.DataManagement.Courses.CheckAndPublish.Query() { IsNonLars = true };
        ...
        public async Task<IActionResult> CheckAndPublish(ViewModels.DataManagement.Courses.CheckAndPublish.Command command)
        {
            command.IsNonLars = false;
            return await _mediator.SendAndMapResponse(
                command,
        ...
        [JourneyMetadata("PublishCourseUpload", typeof(PublishJourneyModel), appendUniqueKey: false, requestDataKeys: "providerId?")]
        public async Task<IActionResult> NonLarsCheckAndPublish(ViewModels.DataManagement.Courses.CheckAndPublish.Command command)
        {
            command.IsNonLars = true;
            return await _mediator.SendAndMapResponse(
                command,
        ...
        public async Task<IActionResult> Published()
        {
            ...
            return await _mediator.SendAndMapResponse(new ViewModels.DataManagement.Courses.Published.Query() { }, vm => View(vm));
        }
        ...
        public async Task<IActionResult> DownloadErrors() => await _mediator.SendAndMapResponse(
            new ViewModels.DataManagement.Courses.DownloadErrors.Query() { IsNonLars = false },
        ...
        public async Task<IActionResult> DownloadNonLarsErrors() => await _mediator.SendAndMapResponse(
           new ViewModels.DataManagement.Courses.DownloadErrors.Query() { IsNonLars = true },
        ...
        public async Task<IActionResult> NonLarsErrors() =>
           await _mediator.SendAndMapResponse(
               new ViewModels.DataManagement.Courses.Errors.Query() { IsNonLars = true },
               result => result.Match<IActionResult>(
                   noErrors => RedirectToAction(nameof(NonLarsCheckAndPublish), true).WithProviderContext(_providerContextProvider.GetProviderContext()),
                   vm => View(vm)));

        [HttpPost("nonlars-errors")]
        public async Task<IActionResult> NonLarsErrors(ViewModels.DataManagement.Courses.Errors.Command command)
        {
            command.IsNonLars = true;
            return await _mediator.SendAndMapResponse(
                command,
        ...
        public async Task<IActionResult> Errors(bool isNonLars) =>
            await _mediator.SendAndMapResponse(
                new ViewModels.DataManagement.Courses.Errors.Query() { IsNonLars = isNonLars },
                result => result.Match<IActionResult>(
        ...
        [HttpPost("errors")]
        public async Task<IActionResult> Errors(ViewModels.DataManagement.Courses.Errors.Command command) =>
            await _mediator.SendAndMapResponse(
                command,
                result => result.Match<IActionResult>(
                    errors => this.ViewFromErrors(errors),
        ...
        public async Task<IActionResult> DeleteRow(ViewModels.DataManagement.Courses.DeleteRow.Query request) =>
            await _mediator.SendAndMapResponse(
                request,
                vm => View(vm));

        [HttpPost("resolve/{rowNumber}/details/delete")]
        public async Task<IActionResult> DeleteRow([FromRoute] int rowNumber, ViewModels.DataManagement.Courses.DeleteRow.Command command)
        {
            command.IsNonLars = false;
            command.RowNumber = rowNumber;
            return await _mediator.SendAndMapResponse(
        ...
        public async Task<IActionResult> DeleteNonLarsRow(ViewModels.DataManagement.Courses.DeleteRow.Query request) =>
            await _mediator.SendAndMapResponse(
                request,
                vm => View(vm));

        [HttpPost("nonlars-resolve/{rowNumber}/details/delete")]
        public async Task<IActionResult> DeleteNonLarsRow([FromRoute] int rowNumber, ViewModels.DataManagement.Courses.DeleteRow.Command command)
        {
            command.IsNonLars = true;
            command.RowNumber = rowNumber;
            return await _mediator.SendAndMapResponse(
