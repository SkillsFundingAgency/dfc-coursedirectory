...
namespace Dfc.CourseDirectory.WebV2.ViewModels.TLevels.AddTLevel.Description
{
        ...
        IRequestHandler<Command, OneOf<ModelWithErrors<ViewModel>, Success>>
    {
        ...
        private void ThrowIfFlowStateNotValid()
        {
            ...
            if (!_journeyInstance.State.CompletedStages.HasFlags(AddTLevelJourneyCompletedStages.SelectTLevel,
