...
namespace Dfc.CourseDirectory.WebV2.ViewModels.TLevels.AddTLevel.SelectTLevel
{
    ...
    public class CommandValidator : AbstractValidator<Command>
    {
        public CommandValidator(IReadOnlyCollection<TLevelDefinition> tLevelDefinitions)
        {
            RuleFor(c => c.SelectedTLevelDefinitionId)
                ...
                .WithMessage("Select the T Level qualification to publish to the course directory");
        }
    }
}
